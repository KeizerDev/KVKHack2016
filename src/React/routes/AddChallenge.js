...
export default class AddChallenge extends React.Component {
    ...
    render() {
        ...
        <form method="post" action="/api/login">
            ...
            <input className="form-control" type="username" name="username" id="name-input" placeholder="Zwemmen met Henk" />
            </div>
            </div>
            ...
            <div className="col-xs-9">
            <input className="form-control" type="username" name="username" id="name-input" placeholder="Je ziet dit telkens als je de app opent" />
            </div>
            </div>
